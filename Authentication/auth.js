...
// // SIGN UP FUNCTIONALITY (UPDATED FOR ADMIN TABLE)
// async function signUp(e) {
//   e.preventDefault();

//   // 1. Validation (Check fields)
...
//   try {
//     // --- STEP 1: Asli Account Banao (Auth) ---
//     const { data, error } = await supaBase.auth.signUp({
//       email: sEmail.value,
//       password: sPass.value,
//       options: {
...
//         text: "Account created and saved to database.",
//         icon: "success",
//         confirmButtonColor: "#003b46",
//         confirmButtonText: "Go to Login"
//       }).then(() => {
//         location.href = "login.html"; // Login page pr bhejo
//       });
//     }
